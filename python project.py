...
def Add_Run_Details():
    ...
    global img
    img=ImageTk.PhotoImage(Image.open('Bus_for_project.png'))
...
def Add_Database_Details():
    ...
    #adding buttons
    btn_newoperator=Button(fr1,text='New Operator',bg='light green',font=("Helvetica",15),command=Add_Operator_Details)
    btn_newoperator.grid(row=0,column=0,padx=10)
    btn_newbus=Button(fr1,text='New Bus',bg='orange',font=("Helvetica",15),command=Add_Bus_Details)
    ...
    btn_newrun=Button(fr1,text='New Run',bg='purple',font=("Helvetica",15),command=Add_Run_Details)
...
def create_window2(event):
    ...
    btn2=Button(fr1,text='Check Booked Seat',bg='green',font=('Helvetica',15),command=Check_Booked_Seat)
    btn2.grid(row=0,column=1,padx=10)
    
    btn3=Button(fr1,text='Add Database Details',bg='green',font=('Helvetica',15),command=Add_Database_Details)
...
label1.pack(pady=10)
Label(root,text="Name:Prateek Swami",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Er : 221B274",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Mobile: 8826211254",fg='blue',font=('Helvetica',15)).pack(pady=10)
